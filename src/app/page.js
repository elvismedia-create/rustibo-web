  ...
  return (
    <div className="pb-20 md:pb-0">
      <section className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8">
        <div className="group relative min-h-[520px] overflow-hidden rounded-[28px] border border-[var(--color-green-border)] bg-[var(--color-green-dark)] text-[var(--color-white)]">
          <div
            className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
            style={{ backgroundImage: "url('/images/hero-rustibo-comidas-para-llevar.jpg')" }}
          />
          <div className="relative z-10 flex min-h-[520px] max-w-lg flex-col items-start justify-center px-6 py-10 sm:px-10 lg:px-14 bg-gradient-to-r from-[var(--color-green-dark)] via-[var(--color-green-dark)]/80 to-transparent">
      ...
      <Link
        href="/carta"
        className="order-button font-brand-menu fixed bottom-5 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3 rounded-2xl px-8 py-4 text-xl uppercase md:hidden"
      >
        Comenzar pedido
        <Phone size={22} />
      </Link>
